// Enhanced tokens.ts with multihop router configuration
// Copy this back to config/tokens.ts when ready to re-enable multihop
...
// Router contract configuration - REPLACE WITH ACTUAL VALUES WHEN DEPLOYED
export const ROUTER = {
  contract_address: 'secret1PLACEHOLDER_ROUTER_ADDRESS_CHANGE_ME', // TODO: Replace with actual router address
  code_hash: 'PLACEHOLDER_CODE_HASH_CHANGE_ME', // TODO: Replace with actual router code hash
};

// Multihop feature flag - MUST be set to true only after router is deployed and tested
export const MULTIHOP_ENABLED = false; // TODO: Set to true after router deployment
