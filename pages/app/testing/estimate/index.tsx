...
// import { QueryMsg } from "@/types/secretswap/factory";
...
export default function EstimatePage() {
  // page not implemented, lead them home
  // redirect("/");
  // try {
  //   throw new Error("Estimate page not implemented");
  //   // eslint-disable-next-line @typescript-eslint/no-unused-vars
  // } catch (_e) {
  //   console.error("Redirecting to home because estimate page not implemented.");
  // } finally {
  //   redirect("/");
  // }
  // return <div>Estimate</div>;
  // Redirect not working, fuck it, big fuckign home button
  return (
    <Link
      href="/"
      className="text-2xl font-bold text-adamant-accentBg mx-auto w-full flex items-center min-h-screen justify-center"
    >
      Page not implemented. Click here to go to the home page.
    </Link>
  );
}
